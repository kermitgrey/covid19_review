...
DROP TABLE cov_cdc_deaths;
DROP TABLE cov_cdc_deaths_codes;
...
CREATE TABLE cov_cdc_deaths_codes(
ethniccode            varchar2(10 char),
ethniclabel           varchar2(50 char),
CONSTRAINT cov_cdc_deaths_codes_PK PRIMARY KEY(ethniccode)
);

CREATE TABLE cov_cdc_deaths(
statefips		VARCHAR2(2 CHAR) NOT NULL,
countyfips		VARCHAR2(5 CHAR) NOT NULL,
gender			VARCHAR2(1 CHAR) NOT NULL,
ethniccode		VARCHAR2(20 CHAR) NOT NULL,
reportyear		VARCHAR2(4 CHAR) NOT NULL,
deaths			NUMBER NOT NULL,
constraint cov_cdc_deaths_PK Primary Key(statefips, countyfips, gender, ethniccode, reportyear),
constraint cov_cdc_deaths_FK Foreign Key(statefips, countyfips) references cov_fipscounty,
constraint cov_cdc_deaths_codes_FK Foreign Key(ethniccode) references cov_cdc_deaths_codes
);
...
DROP TABLE ext_cdc_deaths_load;
...
CREATE TABLE ext_cdc_deaths_load(
state_code                       varchar2(02 char),
...
reportyear                       varchar2(4 char)
    ...
    (
        ...
        (
            ...
            readsize 2777834
            skip 1
            badfile ext_bad_dir:'cdcdeaths.bad'
            logfile ext_log_dir: 'cdcdeaths.log'
